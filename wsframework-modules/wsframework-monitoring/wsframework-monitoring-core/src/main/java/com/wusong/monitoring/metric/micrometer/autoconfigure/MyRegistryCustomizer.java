...
import com.wusong.monitoring.metric.micrometer.MeterMapCleanerTask;
...
import static com.wusong.monitoring.metric.micrometer.MonitorConfigSpringApplicationRunListener.METRICS_INFLUX_TAGS_IGNORE;
...
public class MyRegistryCustomizer implements MeterRegistryCustomizer {
    ...
    private static class TimerMeterFilter implements MeterFilter {
        ...
        public double[] getPercentiles() {
            ...
            if (!percentileString.equals(lastPercentileString)) {
                lastPercentileString=percentileString;
